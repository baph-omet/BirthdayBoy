...
public class Messaging {
	...
	public static String noSuchSubcommand(String subcommand) {
		return ChatColor.RED + "No such subcommand \"" + subcommand
				+ "\". Type \"/birthday help\" for a list of commands.";
	}

	public static String birthdayNotSet() {
		return ChatColor.RED + "Your birthday has not yet been set. Use \"" + ChatColor.YELLOW
				+ "/birthday set <yyyyMMdd>" + ChatColor.RED + "\" to set.";
	}
	...
	public static String[] showBirthdayInfo(Birthday b, String name) {
		return new String[] {
				ChatColor.BLUE + "Birthday for " + name + " is: " + ChatColor.YELLOW + b.ToReadableString()
						+ ChatColor.BLUE + ".",
				ChatColor.BLUE + "Last claimed birthday gift: " + ChatColor.YELLOW
						+ (b.LastClaimedDate == null ? "never" : b.LastClaimedToReadableString()) + ChatColor.BLUE
						+ "." };
	}

	public static String notYourBirthday() {
		return ChatColor.RED + "It's not your birthday! Use " + ChatColor.YELLOW + "/bday" + ChatColor.BLUE
				+ " to check your set birthday.";
	}

	public static String noSameDay() {
		return ChatColor.RED
				+ "You cannot set your birthday to the current day. If today is actually your birthday, try again tomorrow!";
	}
	...
	public static String invalidWorld(Iterable<String> validWorlds) {
		return ChatColor.RED + "You cannot claim your birthday reward in this world. Valid worlds: "
				+ String.join(",", validWorlds);
	}
	...
	public static String setBdayPrompt() {
		return ChatColor.RED + "Before you can join the server, please take a moment to set your date of birth. Type \""
				+ ChatColor.YELLOW + "/bday set <yyyyMMdd>" + ChatColor.RED + "\" to set your date of birth.";
	}
	...
	public static String tooOld(String age) {
		return ChatColor.RED + "Invalid date. Must be after " + age;
	}
}
